<?php
$nomPage = "Réclamtions non traitées";
    ...
    <div class="main-body">
        <div class="card">
            <div class="card-header">
                <strong>Liste des réclamations non traitées</strong>
            </div>
            <div class="card-body card-block">
                <?php if (isset($_GET['validation']) && $_GET['validation'] == 1) {
                ?>
                    <div class="alert alert-success" role="alert">
                        Vouz avez traiter la réclamation avec succès
                    </div>
                <?php
                } ?>
                <?php
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="../controle/traiterReclamation.php" method="POST" style="display:inline;">
                                                <input type="hidden" name="id" value="<?php echo $reclamation->idReclamation ?>">
                                                <button onclick="return confirm('Are you sure ?')" type="submit" class="btn btn-success btn-sm mb-1" type="button" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fas fa-check"></i></button>
                                            </form>
